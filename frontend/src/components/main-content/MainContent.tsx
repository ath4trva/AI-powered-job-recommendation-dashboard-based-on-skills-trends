    ...
    <div className="min-h-screen bg-gray-50 pt-28 pb-8">
      <div className="w-full px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start mt-8">
          ...
          {/* Center Feed: Action Center & Recommendations */}
          ...
          {/* Right Sidebar: Market Insights & Saved Jobs Widget */}
          <div className="hidden lg:block lg:col-span-3">
            <RightSidebar onReviewSavedJobs={onViewSavedJobs} />
          </div>
